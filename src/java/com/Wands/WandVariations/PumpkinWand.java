...
public class PumpkinWand extends Wand {
    ...
    public void runAction(Player player) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            BukkitUtils.emitParticlesContinuously(bat, Particle.FLAME, 1, 0.01, new Vector(0.5f, 0.5f, 0.5f), this.main, 0, 5, 20 * (int) this.duration);
            BukkitUtils.emitParticlesContinuously(bat, Particle.CLOUD, 1, 0.01, new Vector(0.5f, 0.5f, 0.5f), this.main, 0, 5, 20 * (int) this.duration);
            BukkitUtils.emitParticlesContinuously(bat, Particle.SQUID_INK, 1, 0.01, new Vector(0.5f, 0.5f, 0.5f), this.main, 0, 5, 20 * (int) this.duration);
                    ...
                    for (Entity entity : bat.getNearbyEntities(PumpkinWand.this.range, PumpkinWand.this.range, PumpkinWand.this.range)) {
                        ...
                        if (rdm.nextInt(101) <= PumpkinWand.this.chance) {
                            ...
                            if (entity != player
                                ...
                                // Play some particles
                                BukkitUtils.emitParticles(entity.getWorld(), entity.getLocation(), Particle.CRIT_MAGIC, 5, 0.1, new Vector(0.5, 0.5, 0.5));
