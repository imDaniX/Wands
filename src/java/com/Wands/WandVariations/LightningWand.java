...
public class LightningWand extends Wand {
    ...
    public void runAction(Player player) {
        ...
        Location lightningLocation = targetLocation.clone().add(0.5f, 1, 0.5f);
        ...
        BukkitUtils.emitParticles(lightningLocation.getWorld(), lightningLocation, Particle.PORTAL, 500, 1, new Vector(0, 0, 0));
    }
